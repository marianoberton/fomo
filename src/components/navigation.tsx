...
export default function Navigation() {
  ...
  return (
    <div className="w-full flex justify-center py-2 md:py-3 fixed top-0 z-50">
      <header 
        className="bg-white/90 backdrop-blur-md text-slate-800 rounded-full shadow-lg border border-gray-200/50 flex items-center justify-between px-4 sm:px-6 h-12 sm:h-14 w-auto max-w-fit transition-all duration-300 hover:shadow-xl"
      >
        ...
        <div className="md:hidden flex items-center pl-4">
          <button
            ...
            className="p-2 rounded-full text-slate-700 transition-colors hover:bg-brilliantBlue/10 hover:text-brilliantBlue focus:outline-none"
