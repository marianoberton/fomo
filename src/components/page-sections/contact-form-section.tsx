...
import { submitContactLead, sendFallbackEmail, trackFormSubmission, type ContactFormData } from "@/lib/api";
...
export default function ContactFormSection() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Submit to external multitenant system
      ...
      if (result.success) {
        ...
        // If API fails, try fallback email
        console.warn('Primary API failed, attempting fallback:', result.error);
