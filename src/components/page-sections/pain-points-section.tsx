                  ...
                  <Card className={`relative ${theme.bg} border-2 ${theme.border} rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300`}>
                    <CardContent className="p-5">
                      ...
                      <div className="space-y-3">
                        <div className={`text-sm font-semibold ${theme.text} opacity-80 mb-2`}>Síntomas comunes:</div>
                        {point.symptoms.slice(0, 3).map((symptom, symptomIndex) => (
                          <div key={symptomIndex} className="flex items-start gap-2.5">
                            ...
                            <span className={`text-sm ${theme.text} opacity-75 leading-relaxed flex-1`}>
                              {symptom}
                            </span>
                          </div>
                        ))}
                                ...
                                {point.symptoms.slice(0, 3).map((symptom, symptomIndex) => (
                                  ...
                                  >
                                    <div className="flex-shrink-0 mt-1">
                                      <div className={`w-5 h-5 rounded-lg flex items-center justify-center shadow-sm transition-all duration-300 group-hover:scale-110 ${
                                        index === 0 ? 'bg-slate-900' : 'bg-white/20'
                                      }`}>
                                        <svg 
                                          className={`w-3 h-3 ${
