        ...
        >
          ...
          >
            <div className="flex w-full h-full relative max-w-5xl mx-auto px-8">
              ...
              {/* Right Section - Better balanced */}
              <div className="w-5/12 relative flex items-center justify-start pl-4">
                {processSteps.map((step, index) => (
                  <div
                    key={step.number}
                      ...
                      <div className="bg-gradient-to-r from-signalYellow/10 to-orange-500/10 p-4 border-b border-signalYellow/20">
                        <div className="flex items-center gap-3">
                          <div className="relative">
                            <div className="w-12 h-12 bg-gradient-to-br from-signalYellow to-orange-500 rounded-2xl flex items-center justify-center shadow-lg">
                              <step.icon className="w-6 h-6 text-slate-900" />
                            </div>
                            <div className="absolute -top-1 -right-1 w-6 h-6 bg-slate-900 rounded-full flex items-center justify-center border-2 border-signalYellow">
                              <span className="text-signalYellow font-bold text-xs">{step.number}</span>
                            </div>
                          </div>
        ...
        <section className="lg:hidden w-screen pt-4 pb-8 relative" style={{ backgroundColor: '#222222' }}>
          <div className="w-full px-4 sm:px-6">
            <div className="space-y-6 relative">
              ...
              <motion.div 
                className="absolute left-1/2 top-8 bottom-8 w-0.5 bg-gradient-to-b from-signalYellow/30 via-white/20 to-orange-500/30 z-0"
              ...
              {processSteps.map((step, index) => (
                ...
                >
                  ...
                  <div className="w-full relative z-10">
                                          <Card className="border-2 border-signalYellow/40 shadow-xl rounded-2xl overflow-hidden backdrop-blur-sm relative" style={{ backgroundColor: '#1a1a1a' }}>
                        {/* Card Header */}
                        <div className="bg-gradient-to-r from-signalYellow/10 to-orange-500/10 p-4 border-b border-signalYellow/20">
                          <div className="flex items-center gap-4">
                            <div className="relative">
                              <motion.div 
                                className="w-12 h-12 bg-gradient-to-br from-signalYellow to-orange-500 rounded-xl flex items-center justify-center shadow-lg"
                              ...
                              {/* Step number badge - on top of icon like desktop */}
                              <motion.div 
                                className="absolute -top-1 -right-1 w-6 h-6 bg-slate-900 rounded-full border-2 border-signalYellow z-10 shadow-lg flex items-center justify-center"
                                initial={{ scale: 0 }}
                                whileInView={{ scale: 1 }}
                                transition={{ duration: 0.5, delay: index * 0.15 + 0.3, type: "spring", stiffness: 200 }}
                                viewport={{ once: true }}
                              >
                                <span className="text-signalYellow font-bold text-xs leading-none">
                                  {step.number}
                                </span>
                              </motion.div>
                            </div>
                          ...
                          <ul className="space-y-3">
                            {step.details.map((detail, detailIndex) => (
                              <motion.li 
                                ...
                                transition={{ duration: 0.3, delay: index * 0.2 + 0.6 + (detailIndex * 0.1) }}
                                viewport={{ once: true }}
                              >
