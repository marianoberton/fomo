...
export default function ThreePillarsSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full relative" style={{ minHeight: '200vh' }}>
      {/* Sticky Header with Video Background */}
      <div className="sticky top-0 w-full h-screen z-10 overflow-hidden">
        {/* Video Background - contained within sticky header */}
        <video
          autoPlay
          muted
          loop
          ...
          style={{ filter: 'brightness(0.2) contrast(1.3) saturate(0.8)' }}
        >
          <source src="/videos/hero_video_ilu_blanca.mp4" type="video/mp4" />
        </video>
        
        {/* Video overlays for better text readability */}
        <div className="absolute inset-0 bg-gradient-to-br from-plum/90 via-plum/85 to-black/80 z-5"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-black/30 z-5"></div>
      ...
      {/* Content Section - Regular flow */}
      <div className="w-full py-24 bg-plum relative">
